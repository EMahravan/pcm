...
namespace viscosityModelPCMs
{
    ...
    addToRunTimeSelectionTable(viscosityModelPCM, Newtonian, dictionary);
}
}
...
Foam::viscosityModelPCMs::Newtonian::Newtonian
(
    const word& name,
...
bool Foam::viscosityModelPCMs::Newtonian::read
(
    const dictionary& viscosityProperties
)
{
