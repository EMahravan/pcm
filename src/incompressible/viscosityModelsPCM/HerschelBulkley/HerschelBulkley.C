...
Foam::viscosityModelPCMs::HerschelBulkley::calcNu() const
{
...
Foam::viscosityModelPCMs::HerschelBulkley::HerschelBulkley
(
    const word& name,
...
bool Foam::viscosityModelPCMs::HerschelBulkley::read
(
    const dictionary& viscosityProperties
)
{
